        ...
        <CardContent className="p-6 flex flex-col sm:flex-row items-start gap-6">
          ...
          <div className="flex-1 space-y-3">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-x-4 gap-y-2 text-sm text-muted-foreground">
              ...
              <div className="flex items-center"><Droplets className="w-4 h-4 mr-2 text-primary" /> Grupo Sanguíneo: {patient.bloodType ? formatBloodType(patient.bloodType) : 'No especificado'}</div>
