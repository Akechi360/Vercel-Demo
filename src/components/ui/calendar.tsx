...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      className={cn("p-4 test-calendar-styles", className)}
      classNames={{
        ...
        day: cn(
          ...
          "h-10 w-10 p-0 font-normal aria-selected:opacity-100 hover:bg-accent hover:text-accent-foreground transition-all rounded-lg"
        ),
